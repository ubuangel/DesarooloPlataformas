...
public class WithdrawalMenu extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        amountLabel.setText("Retirar Monto");
            ...
            try {
                ...
                if (result == JOptionPane.OK_OPTION) {
                    try {
                        ...
                        warnings.append("Fondos insuficientes para completar la transacción.\n");
                    }
                    
                }
            } catch (NumberFormatException ex) {
                warnings.append("La cantidad de retiro debe ser un número.\n");
            }
        }
