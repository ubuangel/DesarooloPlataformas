    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
       StringBuilder warnings = new StringBuilder();
        ...
        if (depositField.getText().isEmpty()) {
            warnings.append("El deposito inicial debe ser ingresado.");
        } else {
            try {
                amount = Bank.round(Double.parseDouble(depositField.getText()), 2);
            } catch (NumberFormatException ex) {
                warnings.append("El depósito inicial debe ser un número..");
            }
        }
        if (warnings.length() > 0) {
            ...
            if (typeField.getSelectedItem().toString() == "Checking") {
                if (amount >= 100) {
                    ...
                    warnings.append("El deposito inicial debe ser de al menos $100 para cuentas corrientes.");
                }
            } else if (typeField.getSelectedItem().toString() == "Savings") {
                if (amount >= 50) {
                    accountType = AccountType.Savings;
                } else {
                    warnings.append("El depósito inicial debe ser de al menos $ 50 para cuentas de ahorro.");
                }
            }
