...
public class DepositMenu extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        amountLabel.setText("Monto a Depositar:");
    ...
    private void depositButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_depositButtonActionPerformed
       StringBuilder warnings = new StringBuilder();
        ...
        if (amountField.getText().isEmpty()) {
            warnings.append("el monto del deposito es necesario.\n");
        } else {
            double amount = 0;
            ...
            try {
                ...
                if (result == JOptionPane.OK_OPTION) {
                    try {
                        ...
                        warnings.append("El monto del deposito no es valido.\n");
                    }
                    
                }
            } catch (NumberFormatException ex) {
                warnings.append("El deposito debe ser un numero.\n");
            }
        }
